...
*   **Application** refers to current application, the software program provided by the Company.
    
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to current application.
...
*   By email: ing.jose.joya@gmail.com
